                            ...
                            <div class="cover-body d-flex justify-content-between align-items-center">
                                ...
                                <div class="wrapper">
                                    <div class="follow">
                                        @if(Auth::id()!=$user->id)
                                            @if(Auth::check())
                                                <form id="follow_or_unfollow_form" method="post"
                                                      action="/follow_or_unfollow/{{$user->id}}">
                                                    @csrf

                                                    @if(Auth::user()->following->contains($user->id))
                                                        <button class="unfollow user_follow" type="submit">Unfollow
                                                        </button>
                                                    @else
                                                        <button class="user_follow" type="submit ">Follow</button>
                                                    @endif
                                                </form>
                                            @else
                                                <a href="{{route('login')}}">
                            ...
                            @if($post->images->count()>0)
                                <div class="col-md-12 grid-margin">
                                    <div class="card rounded">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center">
                                                    <img class="img-xs rounded-circle"
                                                         src="/images/profile_photos/{{$user->profile_photo}}" alt="">
                                                    <div class="ml-2">
                                                        <p style="margin-bottom: 0rem;">{{$post->user->name}}</p>
                                                        <p style="margin-bottom: 0rem;"
                                                           class="tx-11 text-muted">{{$post->created_at->format('d-m-Y')}}</p>
                                                    </div>
                                                </div>
                                                <div class="dropdown">
                                        ...
                                        <div class="card-body">
                                            <p class="mb-3 tx-14"><a style="color: black"
                                                                     href="/post/{{$post->id}}">{{Str::limit($post->content,200)}}</a>
                                                <a href="/post/{{$post->id}}">go to post</a></p>
                                            <a href="/post/{{$post->id}}"><img style="width: 620px; height: 380px;"
                                                                               class="img-fluid"
