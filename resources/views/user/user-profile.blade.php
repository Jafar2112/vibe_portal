                    ...
                    <div class="profile-header">
                        <div class="cover">
                            ...
                            <figure style="width: 200px;">
                                <img  src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAASwAAACoCAMAAABt9SM9AAAAA1BMVEX///+nxBvIAAAAR0lEQVR4nO3BAQEAAACCIP+vbkhAAQAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAO8GxYgAAb0jQ/cAAAAASUVORK5CYII=" class="img-fluid" alt="profile cover">
                            </figure>
                            <div class="cover-body d-flex justify-content-between align-items-center">
                                <div>
                                    <img class="profile-pic" src="/images/profile_photos/{{$user->profile_photo}}" alt="profile">
                        ...
                        @foreach($posts as $post)
                            @if($post->images->count()>0)
                                ...
                                <div class="card rounded">
                                    <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <img class="img-xs rounded-circle" src="/images/profile_photos/{{$user->profile_photo}}" alt="">
                                                <div class="ml-2">
                                                    <p style="margin-bottom: 0rem;">{{$post->user->name}}</p>
                                                    <p style="margin-bottom: 0rem;" class="tx-11 text-muted">{{$post->created_at->format('d-m-Y')}}</p>
                                                </div>
                                            </div>
                                            <div class="dropdown">
                                    ...
                                    <div class="card-body">
                                        <p class="mb-3 tx-14"><a style="color: black" href="/post/{{$post->id}}">{{Str::limit($post->content,200)}}</a> <a href="/post/{{$post->id}}">go to post</a></p>
                                        <a href="/post/{{$post->id}}"><img style="width: 620px; height: 380px;" class="img-fluid" src="/images/post/{{$post->images[0]->image}}" alt=""></a>
                                    </div>
